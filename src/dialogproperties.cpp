    ...
    :QDialog(parent)
{
    ...
    typeData = new QLabel(QString("%1").arg(QString(QImageReader(currentCellItem->getImagePath()+
                                                                 QDir().separator()+currentCellItem->getImageName()+
                                                                 "."+
                                                                 currentCellItem->getImageType()).format())),pageGeneral);
...
void DialogProperties::updateData()
{
    ...
    typeData->setText(QString("%1").arg(QString(QImageReader(currentCellItem->getImagePath()+
                                                     QDir().separator()+currentCellItem->getImageName()+
                                                     "."+
                                                     currentCellItem->getImageType()).format())));
